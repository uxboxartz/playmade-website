...
document.querySelectorAll('a[href^="#"]').forEach((anchor) => {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateCarousel() {
      const blogCardWidth = document.querySelector(".blog-card").offsetWidth; // ✅ Get correct width
      const translation = -currentIndex * blogCardWidth;
      blogCards.style.transform = `translateX(${translation}px)`; 
...
gsap.utils.toArray(".reveal").forEach((element) => {
  gsap.fromTo(
    ...
    { opacity: 50, x: 100 },
    {
      ...
      scrollTrigger: {
        trigger: element,
        start: "top 80%", // Triggers when the element enters the viewport
...
document.querySelector(".logo").addEventListener("click", function() {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    // Remove 'active' class from all links and add to the current page
